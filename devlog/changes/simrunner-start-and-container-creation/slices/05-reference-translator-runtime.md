...
### S05-M2 — Translator template boundary
...
### S05-M3 — Reference generator and database runtime
...
### S05-M4 — Durable image outcome and recovery
...
### S05-A1 — BuildKit admission-gate completion
...
### S05-A2 — Translator, generator, and runner completion
...
### S05-A3 — Cross-client endpoint conformance
...
#### S05-D07 — Full-smoke template selection

Retire `test/mocks/translator` from the full smoke path. The smoke fixture selects the reference Scenario Detail Database image but does not create or insert its parameter rows.
