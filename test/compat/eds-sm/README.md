...
- Scenario Manager image available to the cluster
  - default in `manifests.yaml`: `registry.unibw.de/i31bdase/cbse-test/sm:26.7.16`
  - override at runtime with `SM_IMAGE=<your-image>`
- EDS mock image available to the cluster
  - default in `eds-mock.yaml`: `registry.unibw.de/i31bdase/cbse-test/eds-mock:26.7.16`
